...
ENDPOINT="http://10.99.0.102:8000,http://10.99.0.103:8000,http://10.99.0.104:8000"
#echo $ENDPOINT
...
OBJ_SIZE=("4Kb" "128Kb" "1Mb" "4Mb" "64Mb" "128Mb")
SAMPLES=(99999 99999 9999 9999 5000 5000)
CLIENTS=(200 200 100 100 100 100) #FOR WRITES
#CLIENTS=(150 150 100 100 75 75) #FOR READS
LOOP_COUNT=3
ARR_SIZE=${#OBJ_SIZE[*]}
